...
import 'package:salvest_app/presentation/sale%20estate/widgets/custom_button.dart'
    show CustomSendButton;

class SendPropertyButton extends StatelessWidget {
  const SendPropertyButton({super.key});

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(top: 20, bottom: 8.0),
      child: BlocBuilder<SalePropertyBloc, SalePropertyState>(
          ...
          return CustomSendButton(
            ...
            onTap: () {
              context.read<SendPropertyBloc>().add(
                SendPropertyApiEvent(salePropertyState: state),
              );
            },
          );
        },
