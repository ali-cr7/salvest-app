...
import 'package:salvest_app/presentation/property%20details/widgets/investment_button_with_auth.dart';
    ...
    void _depat() async {
      ...
      deputizationsBloc.add(
        CreateDeputizationsEvent(
          ...
          deputizationContent: deputizationText,
        ),
      );
    }
      ...
      body: BlocListener<WalletBloc, WalletState>(
        listener: (context, state) {
          ...
          if (state is InvestFailure) {
            ...
            // );
            EasyLoading.showError(state.helperResponse.fullBody!['message']);
          }
        },
        child: BlocListener<DeputizationsBloc, DeputizationsState>(
          listener: (context, state) {
                          ...
                          CustomSendButton(
                            ...
                            onTap: () async {
                              ...
                              try {
                                ...
                                print(
                                  'the deputizationState is  $deputizationState',
                                );
